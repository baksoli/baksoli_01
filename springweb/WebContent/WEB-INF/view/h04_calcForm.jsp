...
<h2>구구단 문제</h2>
	<form:form commandName="calculation">
		<form:input path="quest1" id="quest1" style="border-width:0; width:50px;" readonly="true"/>
		...
		<br>
		<form:input path="quest2" id="quest2" style="border-width:0; width:50px;" readonly="true"/>
